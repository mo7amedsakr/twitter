...
export const fetchTweetsStart = (url, page) => {
  return { type: actionTypes.FETCH_TWEETS_START, url, page };
};

export const fetchTweetsSuccess = (tweets, page) => {
  return { type: actionTypes.FETCH_TWEETS_SUCCESS, tweets, page };
};
