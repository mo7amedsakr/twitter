...
const Label = styled.label`
  ...
  ${({ theme, checked }) => checked && `border: 2px solid ${theme.user_color};`}
`;
...
const Span = styled.span`
  ...
  ${({ theme, checked }) =>
    checked &&
    `border: 2.5px solid ${theme.user_color};background-color:${theme.user_color} !important;`}
`;
  ...
  return (
    <div className={classes.BackgroundInput}>
      ...
      >
        ...
        {props.checked ? (
          <div className={classes.BackgroundInput_Label_Checked}>
            <FiCheck />
          </div>
        ) : null}
